...
`skills/clean-architecture/SKILL.md`, `skills/clean-code/SKILL.md`, `skills/conventional-commits/SKILL.md`, `skills/writing-style/SKILL.md`, `skills/token-budget/SKILL.md`, and `skills/infrastructure-as-code/SKILL.md` are shared references for the commands. Each one is the single source of truth for its topic. Don't duplicate architecture rules, code-level quality rules, commit format rules, writing rules, token management rules, or infrastructure rules inside the command files. Reference the matching skill instead.
