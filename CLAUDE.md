...
forge is a repo-agnostic engineering workflow plugin for Claude Code. It scaffolds Clean Architecture project templates, executes development tasks, writes long-form prose, compiles ebooks, reviews diffs, and ships PRs. It is installed across every machine and repo Samuel works in. That includes Hudl repos, personal side projects, and writing projects alike. It must behave identically everywhere.
...
2. Invoke the changed command, `/forge:do-work`, `/forge:review`, `/forge:ship`, `/forge:scaffold`, `/forge:write`, or `/forge:publish`, in a real or scratch repo. Check that the behavior matches the instructions in the file.
